...
struct TripGenerationSettingsView: View {
                ...
                if settings.enableRosterTripGeneration {
                    ...
                    Section {
                        ...
                        Picker("Trip Grouping", selection: $settings.tripGroupingMode) {
                            ForEach(TripGroupingMode.allCases, id: \.self) { mode in
    ...
    private var tripGroupingFooterText: String {
        let confirmationText = settings.requireConfirmation ?
        ...
        switch settings.tripGroupingMode {
        case .automatic:
            groupingText = "Automatic mode groups legs with <12h gaps into trips. "
        case .manual:
            groupingText = "Manual mode lets you select which legs to include in each trip. "
        }
        
        return groupingText + confirmationText
    }
}
